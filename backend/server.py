...
from app.trainer.recomendationTrainer import RecommenderTrainer
from app.rl.drlDataLoader import DRLDataAdapter
from app.rl.dummyDataCreator import RecommenderDataGenerator
...
def home():
    return {
        "message" : "Welcome to Deep Neural Network Recommender Backend System"
    }
